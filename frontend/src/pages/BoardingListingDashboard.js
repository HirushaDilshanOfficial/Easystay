...
export default function BoardingListingDashboard() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const res  = await api.get("/advertisements?status=approved");
        const data = res.data;
      ...
      <div style={{
        ...
        {!loading && ad && (
          <div style={{
            ...
            <div style={{ padding: "30px 48px", maxWidth: 500, ...contentStyle }}>
              ...
              <p style={{
                ...
                lineHeight: 1.7, marginBottom: 16, maxWidth: 400,
